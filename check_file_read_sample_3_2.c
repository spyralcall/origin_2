...
int main(int argc, char **argv){
  ...
  /* ヘッダを捨てる */
  fgets(buf, BUF_SIZE, fp1); /*fgets 関数は fp1 が指すストリームから 1 行分※文字列を読み取り buf が指す配列に格納します．*/
                             /*このとき BUF_SIZE-1 が 1 行の最大文字数となります．配列に格納した文字の後にナル文字 ('\0') を書き込みます．*/
                             /*※ 正確には改行文字または，ファイルの終りまで文字列を読み取ります．(読み取った改行文字も配列に格納します．)*/
